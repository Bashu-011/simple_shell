...
*      else  -1 on error
*/
void prints_errors(x_info *command, char *str_err)
{
...
* @input: the input
* @fil_desc: the filedescriptor to write to
*
* Return: number of characters printed
*/
int print_d(int input, int fil_desc)
{
int (*__putchar)(char) = _putchar;
int i, count = 0;
unsigned int _abs_, current;

if (fil_desc == STDERR_FILENO)
__putchar = _eputchar;
if (input < 0)
{
_abs_ = -input;
...
/**
* convert_number - converter function, a clone of int2alph
* @num: number
* @base: base
